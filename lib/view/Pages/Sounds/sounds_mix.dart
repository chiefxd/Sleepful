...
class SoundsMix extends StatefulWidget {
  const SoundsMix({super.key});

  @override
  State<SoundsMix> createState() => _SoundsMixState();
}

class _SoundsMixState extends State<SoundsMix> {
  final player = AudioPlayer();
  double _currentSliderValue = 0.0;
  double _sliderMaxValue = 2520.0;
