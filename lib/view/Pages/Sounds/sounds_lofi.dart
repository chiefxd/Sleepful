...
class SoundsComfort extends StatefulWidget {
  const SoundsComfort({super.key});

  @override
  State<SoundsComfort> createState() => _SoundsComfortState();
}

class _SoundsComfortState extends State<SoundsComfort> {
  final player = AudioPlayer();
  double _currentSliderValue = 0.0;
  double _sliderMaxValue = 1020.0;
