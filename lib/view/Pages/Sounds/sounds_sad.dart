...
class SoundsRain extends StatefulWidget {
  const SoundsRain({super.key});

  @override
  State<SoundsRain> createState() => _SoundsRainState();
}

class _SoundsRainState extends State<SoundsRain> {
  final player = AudioPlayer();
  double _currentSliderValue = 0.0;
  double _sliderMaxValue = 1800.0;
